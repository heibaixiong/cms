...
function pages($num, $curr_page, $perpage = 20, $urlrule = '', $array = array(),$setpages = 10) {
	...
	if($num > $perpage) {
		...
		if($curr_page>0) {
			//$multipage .= ' <a href="'.pageurl($urlrule, $curr_page-1, $array).'" class="a1 detail_page_left">'.L('previous').'</a><div class="list_page">';
			$multipage .= ' <a href="'.pageurl($urlrule, $curr_page-1, $array).'" class="a1 detail_page_left"></a><div class="list_page">';
			if($curr_page==1) {
				$multipage .= ' <a href="#">1</a>';
		...
		for($i = $from; $i <= $to; $i++) {
			if($i != $curr_page) {
				...
				$multipage .= ' <a href="#">'.$i.'</a>';
			}
		}
		if($curr_page<$pages) {
			if($curr_page<$pages-5 && $more) {
				//$multipage .= ' ..</div><a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a> <a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="a1 detail_page_right">'.L('next').'</a>';
				$multipage .= ' ..<a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a> </div><a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="a1 detail_page_right"></a>';
			} else {
				//$multipage .= ' </div><a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a> <a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="a1 detail_page_right">'.L('next').'</a>';
				$multipage .= ' <a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a> </div><a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="a1 detail_page_right"></a>';
			}
		} elseif($curr_page==$pages) {
			//$multipage .= ' <span>'.$pages.'</span> </div><a href="'.pageurl($urlrule, $curr_page, $array).'" class="a1 detail_page_right">'.L('next').'</a>';
			$multipage .= ' <a href="#">'.$pages.'</a> </div><a href="'.pageurl($urlrule, $curr_page, $array).'" class="a1 detail_page_right"></a>';
		} else {
			//$multipage .= ' <a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a> </div><a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="a1 detail_page_right">'.L('next').'</a>';
			$multipage .= ' <a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a> </div><a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="a1 detail_page_right"></a>';
		}
	}
	return $multipage;
